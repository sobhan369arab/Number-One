...
const ShopCard = ({ item }) => {
    ...
    return (
        <Link to={"/shopDetails/" + item.id} className='w-[300px] h-fit flex flex-wrap gap-y-4 p-5 border border-grayBorder rounded-lg hover:shadow-lg duration-200 relative cursor-pointer'>
