...
const SearchInput = () => {
    ...
    return (
        <>
            <div className="border border-grayCustom h-[42px] w-[70%] text-sm flex items-center rounded-3xl max-xl:hidden ">
                {/* category Section */}
                <div className={`px-3 bg-[url('../icons/BlackArrow.png')] bg-11 bg-no-repeat cursor-pointer
            hover:text-purpleCustom hover:bg-[url('../icons/PurpleArrow.png')] duration-200 
