    ...
    <div className="p-5 bg-grayCustom rounded-lg mb-7">
      ...
      {labelArray.map((item, index) => (
        ...
        >
          ...
          <input type="radio" id={title + index} name={title} className="w-4 h-4 rounded-[4px] checked:bg-[url('../icons/true.PNG')] bg-cover checked:border-none border border-gray-500 bg-white appearance-none" />
