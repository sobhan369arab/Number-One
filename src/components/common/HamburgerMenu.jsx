...
const HamburgerMenu = ({ children, style, width }) => {
    ...
    return (
        <div>
            ...
            <div style={i18n.language != "en" ? { right: visible ? "0" : - width + "px" } : { left: visible ? "0" : - width + "px" }} className={`w-[${width + "px"}] h-svh duration-200 fixed top-0 select-none z-[9999] ${style}`}>
